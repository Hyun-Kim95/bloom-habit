...
extension LocalUserQueryWhere
  ...
  QueryBuilder<LocalUser, LocalUser, QAfterWhereClause> serverIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalUser, LocalUser, QAfterWhereClause> serverIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalUserQueryFilter
  ...
  QueryBuilder<LocalUser, LocalUser, QAfterFilterCondition> serverIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'serverId',
      ));
