...
exports.HabitsModule = HabitsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([entities_1.Habit, entities_1.HabitRecord, entities_1.AiFeedbackLog])],
        controllers: [habits_controller_1.HabitsController],
        providers: [habits_service_1.HabitsService, ai_feedback_service_1.AiFeedbackService],
